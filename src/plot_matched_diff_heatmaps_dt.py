"""
Plot per-layer heatmaps of matched-prompt projection diffs for dataset-matched vectors.
...
Output: one combined heatmap per layer (17 vectors x 17 entity datasets).
...
def plot_heatmap(
    ...
    ax.set_title(
        f"Dataset-Matched Projection Diffs -- Layer {layer}{baseline_note}",
...
def main():
    ...
    out_dir = os.path.join(args.plots_dir, model_short, "dt", "matched_diffs")
